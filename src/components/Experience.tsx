  ...
  const experiences = [
    {
      ...
      highlights: [
        'Developed and maintained INSW application, integrating with multiple government ministries: Ministry of Transportation (Inaport), Ministry of Trade, Ministry of Health, and Ministry of Finance (Pajak & Bea Cukai)',
        'Designed and optimized backend services using Node.js, Express, and PostgreSQL with microservices architecture',
        'Implemented message queue system with RabbitMQ for asynchronous inter-ministry data exchange and Redis for caching layer',
        'Identified and optimized top slow queries in TemBoard, significantly improving database efficiency and reducing query execution time',
        'Implemented query decomposition strategies to improve indexing usage and minimize unnecessary computations',
      ],
      tech: ['Node.js', 'Express', 'PostgreSQL', 'RabbitMQ', 'Redis', 'Microservices', 'TemBoard'],
      current: true,
    },
    {
      ...
      project: 'Enterprise Resource Planning (ERP) & Point of Sale (POS) System',
      highlights: [
        'Developed full-stack ERP application including Point of Sale (POS) with Angular frontend and Node.js backend',
        'Built comprehensive product management, warehouse management, inter-warehouse transfer, and stock management modules',
        'Implemented sales transaction system with Excel data import/export functionality',
        'Integrated third-party e-commerce platforms (Tokopedia, Shopee) for automated product management and stock synchronization',
        'Designed and optimized MySQL database schema, ensuring data integrity and optimal query performance',
      ],
      tech: ['Node.js', 'Express.js', 'Angular', 'MySQL', 'Tokopedia API', 'Shopee API', 'Excel Integration'],
      current: false,
    },
    {
